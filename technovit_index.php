...
<?php include_once("public/Inside/analyticstracking.php") ?>
    ...
    <header>
        <div class="header-content">
            ...
            <a href="public/Inside/technovit/qubit.php" style="color: white; background-color: black; font-family: 'Montserrat', sans-serif;" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-comment"></span> technoVIT'15</a>
            </div>
        </div>
