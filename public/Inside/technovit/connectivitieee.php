...
if (isset($_POST['submit'])) {
    ...
    unset($_POST);
    redirect_to("connectivitieee.php");
}
...
$query = "SELECT * FROM technovit WHERE school='connectivitieee' ORDER BY id DESC";
...
<head>
    ...
    <title>connectiVITieee | technoVIT'15</title>
            ...
            <div class="row">
                <div class="container">
                    <div class="row" style="display: flex; align-items: center; justify-content: center;">
                        <div class="col-md-6">
                            <form method="post" class="search-bar" action="connectivitieee.php" enctype="application/x-www-form-urlencoded">
                ...
                <div class="container">
                    <div class="col-md-12">
                         <ul class="nav nav-tabs ">
                            ...
                            <li>
                                    <a href="diseno.php"><span>Diseno</span></a>
                            </li>
                            <li>
                                    <a href="taikuun.php"><span>Taikuun</span></a>
                            </li>
                            <li class="active">
                                    <a href="connectivitieee.php"><span>connectiVITieee</span></a>
                            </li>
                            <li >
                                    <a href="vitness.php"><span>VITness</span></a>
                            </li>
                            <li >
                                    <a href="informal.php"><span>Informal/Gaming</span></a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active" id="connectivitieee">
                                <div class="profile-env">
                                    <section class="profile-feed">
                                        <!-- profile post form -->
                                        <div <?php echo $view; ?> >
                                        <form class="profile-post-form" method="post" action="connectivitieee.php" enctype="multipart/form-data">
                                            <textarea class="form-control autogrow" name="content" placeholder="connectiVITieee Post"></textarea>
                                        ...
                                        <div class="profile-stories">
                                            <article class="story">                                                
                                                ...
                                                <?php                                                
                                                    while ($technovit_list = mysqli_fetch_assoc($result)) { ?>
                                                        <article class="story">
                                                        <aside class="user-thumb">
                                                        <a href="#">
                                                        <?php 
                                                        $pic_query = "SELECT * FROM users WHERE username = '{$technovit_list['post_user']}' LIMIT 1";
                                        ...
                                        <!-- story header -->
                                                            <header>
                                                                <div class="publisher">
                                                                    ...
                                                                    <em>
                                                                        <?php 
                                                                            $post_time = strtotime($technovit_list['post_time']);
                                                        ...
                                                        <footer>
                                                        <a href="comments.php?id=<?php echo urlencode($technovit_list["id"]); ?>&amp;school=connectivitieee">
                                                        <i class="entypo-comment"></i>
                                                        <?php                                                                
                                                            echo "Comment <span> (";
                                                            $count_query = "SELECT COUNT(*) FROM technovitcomments WHERE pid = {$technovit_list["id"]} AND school='connectivitieee' ";
