...
$query = "SELECT * FROM technovit WHERE school='vitness' ORDER BY id DESC";
...
<head>
    ...
    <title>VITness | technoVIT'15</title>
            ...
            <div class="row">
                <div class="container">
                    <div class="row" style="display: flex; align-items: center; justify-content: center;">
                        <div class="col-md-6">
                            <form method="post" class="search-bar" action="vitness.php" enctype="application/x-www-form-urlencoded">
                ...
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="vitness">
                                <div class="profile-env">
                                    <section class="profile-feed">
                                        <!-- profile post form -->
                                        <div <?php echo $view; ?> >
                                        <form class="profile-post-form" method="post" action="vitness.php" enctype="multipart/form-data">
                                            <textarea class="form-control autogrow" name="content" placeholder="VITness Post"></textarea>
                                        ...
                                        <!-- story header -->
                                                        ...
                                                        <footer>
                                                        <a href="comments.php?id=<?php echo urlencode($technovit_list["id"]); ?>&amp;school=vitness">
                                                        <i class="entypo-comment"></i>
                                                        <?php                                                                
                                                            echo "Comment <span> (";
                                                            $count_query = "SELECT COUNT(*) FROM technovitcomments WHERE pid = {$technovit_list["id"]} AND school='vitness' ";
