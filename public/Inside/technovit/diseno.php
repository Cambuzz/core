...
<head>
    ...
    <title>Diseno | technoVIT'15</title>
            ...
            <div class="row">
                <div class="container">
                    <div class="row" style="display: flex; align-items: center; justify-content: center;">
                        <div class="col-md-6">
                            <form method="post" class="search-bar" action="diseno.php" enctype="application/x-www-form-urlencoded">
                ...
                <div class="container">
                    <div class="col-md-12">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="diseno">
                                <div class="profile-env">
                                    <section class="profile-feed">
                                        <!-- profile post form -->
                                        <div <?php echo $view; ?> >
                                        <form class="profile-post-form" method="post" action="diseno.php" enctype="multipart/form-data">
                                            <textarea class="form-control autogrow" name="content" placeholder="Diseno Post"></textarea>
