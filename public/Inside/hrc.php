...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO hrc (content, picset, post_user, post_time, council) VALUES ('{$content}', {$picset}, '{$post_user}', '{$post_time}', "hrc")";
    $sql = mysqli_query($conn, $query);
    //$main_query = "INSERT INTO app (content, picset, post_user, post_time, council) VALUES ('{$content}', {$picset}, '{$post_user}', '{$post_time}', "hrc")";      
                                ...
                                <div class="profile-env">
                                    <section class="profile-feed">
                                        ...
                                        <form class="profile-post-form" method="post" action="hrc.php" enctype="multipart/form-data">
                                            <textarea class="form-control autogrow" name="content" placeholder="UNHRC Post"></textarea>
                                        ...
                                        <!-- story header -->
                                                        ...
                                                        <footer>
                                                        <a href="hrc_comments.php?id=<?php echo urlencode($mun_list["id"]); ?>">
